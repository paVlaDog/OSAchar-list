                ...
                <AccordionBody>
                    ...
                    {createAccItem("11", "Оружие",
                        <AccordionBody>
                            ...
                            <Accordion alwaysOpen>
                                ...
                                {createAccItem("9", "Боеприпасы",
                                    <AccordionBody>
                                        <div><strong>Стандартный урон двуручного оружия: (Нет владения: 1к6+МОД | Ученик: 1к10+МОД | Ветеран: 2к6+МОД | Мастер: 2к8+МОД)  </strong></div>
                                        {createThings(Things, namesAmmunition, masSumLem[7]).map((a) => a)}
                                    </AccordionBody>
                                )}
                    ...
                    {createAccItem("12", "Доспехи",
                        <AccordionBody>
                            ...
                            <h4>Лёгкие:</h4>
                            {createThings(Things, namesLightArmor, masSumLem[8]).map((a) => a)}
                            <h4>Средние:</h4>
                            {createThings(Things, namesMediumArmor, masSumLem[9]).map((a) => a)}
                            <h4>Тяжёлые:</h4>
                            {createThings(Things, namesHeavyArmor, masSumLem[10]).map((a) => a)}
                        </AccordionBody>
                    )}

                    {createAccItem("13", "Щиты",
                        <AccordionBody>
                            {createThings(Things, namesShield, masSumLem[11]).map((a) => a)}
                        </AccordionBody>
                    )}
                    ...
                    {createAccItem("14", "Магическая фокусировка",
                        <AccordionBody>
                            ...
                            {createThings(Things, namesMagicWeapons, masSumLem[12]).map((a) => a)}
                        </AccordionBody>
                    )}

                    {createAccItem("15", "Обереги",
                        <AccordionBody>
                            {createThings(Things, namesAmulets, masSumLem[13]).map((a) => a)}
                        </AccordionBody>
                    )}

                    {createAccItem("16", "Прочее",
                        <AccordionBody>
                            {createThings(Things, namesOther, masSumLem[14]).map((a) => a)}
                        </AccordionBody>
                    )}
