    ...
    return (
        <Accordion.Item eventKey={accordionNumber}>
            ...
            <Accordion.Body>
                ...
                <div>Если характеристика, к которой прикреплён навык хотя бы +5 и у вас хотя бы 5 уровень, то можно получить Компетентность</div>
                <div>Если характеристика, к которой прикреплён навык хотя бы +7 и у вас хотя бы 10 уровень, то можно получить Мастерство</div>
